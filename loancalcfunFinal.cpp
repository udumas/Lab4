 ...
 *			if the minimum interest payment is greater than the monthly returns error message 
 *			and asks for a new value		
 *		
 *	While the Principle amount is greater than the monthly payment 
 *		1. calculates the amount of the principle that will be paid for each loan payment based on 
 *			the monthly 
 *			payment the user enters
 *		2. calculates the new interest payment amount for the next payment based on the new principle
 *			 amount.
...
//gets a double from the user via keyboard input
//input: void
//output: a double representing the amount of principle 
//		  on the loan
//********************************************
double getLoanAmount();
...
//gets a double from the user via keyboard input
//input: void
//output: a double representing the interest rate
//		  on the loan
//********************************************
double getInterestRate();
...
//			represents the amount necesary to 
//			pay only the monthly Interest on the Loan
//output: a double representing the amount of monthly  
//		  payment for the loan
//********************************************
double getPaymentAmount(double interestPayment);

//*********************************
//double calculateMonths(double principle, double interestRate, double monthlyPayment)   
//function: calculateMonths
//Calculates all required fields for the amortization 
// table for the loan.
...
// calls displayResults to display output to the user.
//input: double principle, double interestRate, double monthlyPayment
//output: an integer representing the number of months until the balance is paid
//********************************************
int calculateMonths(double principle,double interestRate, double monthlyPayment);


//*********************************
//void displayResults(int month,double principle,double monthlyPayment, double interestPayment,
//					  double principlePayment,double totalInterest) 
//function: displayResults
// Displays payment number, balance prior to current payment, payment amount
// interest paid  and principle paid
// for each payment.
// 

//input: int month,double principle,double monthlyPayment,double interestPayment,
//		 double principlePayment,double totalInterest
//output: void
//********************************************
void displayResults(int month, double principle, double monthlyPayment, double interestPayment, 
...
//********************************************
	double getLoanAmount(){
			double loanAmount;
			cout << "Enter Loan Amount\n Formatted as 20000.00 exclude a dollar sign from entry\n";
			cin >> loanAmount;
			return loanAmount;
		}
...
//********************************************
	double getPaymentAmount(double interestPayment){
		...
		double monthlyPayment=0;
		do{
			cout << "Enter your Monthly Payment Amount\n Formatted as 1000.00";
			cout <<	"exclude a dollar sign from entry\n";
			cin >> monthlyPayment;
...
//********************************************
	void displayResults(int month,double principle,double monthlyPayment,double interestPayment,
		 ...
		 */
 		cout << setw(5) << month << setw(15) << principle;
		cout << setw(15) << principle+interestPayment << setw(15) << interestPayment << setw(15); 
		cout << principle <<"\n";
		...
		cout << setw(55) << "Percent of Annualized Interest from the Total Loan:" << setprecision(2); 
		cout << setw(20) <<percentInterest << "%"<< endl;
		}
		}
	}
